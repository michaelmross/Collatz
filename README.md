# Collatz R=2 Cycle Search — Computational Verification

Supplementary code for **"Spike Structures, Finite-State Exclusion, and Bounded-Exponent Collatz Cycles"** by Michael M. Ross.
